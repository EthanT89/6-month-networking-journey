...
// Predefines the max incoming data allowed in bytes
...
/*
** Returns the sockaddr address, compatible with both IPv4 and IPv6
*/
...
int main(void)
{
    ...
    */
    if (!fork()) { // this is the child process TODO: look into this
        ...
        // Wait for input, and depending on the input, send certain information back
